...
def test_example_complex():
    ...
    for s, o in g.subject_objects(SKOS.topConceptOf):
        top_concepts += 1
    assert top_concepts == 3, f"Processing the test vocab (\"example - complex\" sheet in workbook " \
    ...
    for o in g.objects(
            ...
            SKOS.prefLabel):
        assert str(o) == "Particle Type", f"The title (preferredLabel) of the \"example - complex\" sheet vocab in " \
