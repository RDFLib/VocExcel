...
* is under active development and production use
...
==== Latest Template: 0.6.0

Unless you have a good reason to do something different, please use the latest version of the template. Currently, (December, 2022) the latest template is v0.6.0 (VocExcel-template_060.xlsx).
...
This code is licensed using the GPL v3 licence. See the _LICENSE_ for the deed. Note that Excel is property of Microsoft.
